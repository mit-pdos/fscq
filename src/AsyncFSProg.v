...
| FExecRead    :
    forall pr d bm hm tr tr' fsxp inum off (ams ams': BFILE.memstate)
      ...
      exec_fbasic pr tr d bm hm fsxp ams (read_fblock_f inum off)
...
| FExecSetAttr    :
    forall pr d bm hm tr tr' fsxp inum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (file_set_attr fsxp inum attr ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (file_set_attr_f inum attr)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecSetSz    :
    forall pr d bm hm tr tr' fsxp inum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (file_set_sz fsxp inum sz ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (file_set_sz_f inum sz)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecWrite   :
    forall pr d bm hm tr d' bm' hm' tr' fsxp
      ...
      exec_fbasic pr tr d bm hm fsxp ams (update_fblock_d_f inum off v)
...
| FExecTruncate    :
    forall pr d bm hm tr tr' fsxp inum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (file_truncate fsxp inum sz ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (file_truncate_f inum sz)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecFileSync    :
    forall pr d bm hm tr tr' fsxp inum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (file_sync fsxp inum ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (file_sync_f inum)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecReaddir    :
    forall pr d bm hm tr tr' fsxp inum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (readdir fsxp inum ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (readdir_f inum)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecCreate    :
    forall pr d bm hm tr tr' fsxp dnum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (create fsxp dnum name tag ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (create_f dnum name tag)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecLookup    :
    forall pr d bm hm tr tr' fsxp dnum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (lookup fsxp dnum fnlist ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (lookup_f dnum fnlist)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecRename    :
    forall pr d bm hm tr tr' fsxp dnum (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (rename fsxp dnum srcpath srcname dstpath dstname ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (rename_f dnum srcpath srcname dstpath dstname)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecTreeSync    :
    forall pr d bm hm tr tr' fsxp (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (tree_sync fsxp ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (tree_sync_f)
                  (Finished d' bm' hm' r) ams' tr'
...
| FExecTreeSyncNoop    :
    forall pr d bm hm tr tr' fsxp (ams ams': BFILE.memstate)
      ...
      exec pr tr d bm hm (tree_sync_noop fsxp ams)
           (Finished d' bm' hm' ^(ams', r)) tr' ->
      exec_fbasic pr tr d bm hm fsxp ams (tree_sync_noop_f)
                  (Finished d' bm' hm' r) ams' tr'.
...
| FExecBasic    :
    forall T (p :fbasic T) pr fsxp d bm hm tr tr' (ams ams': BFILE.memstate)
     out,
      exec_fbasic pr tr d bm hm fsxp ams p out ams' tr' ->
      fexec pr tr d bm hm fsxp ams (FBasic p) out ams' tr'
                   
| FExecBind :
    forall T T' pr (p1 : fbasic T) (p2: T -> fprog T') fsxp d bm hm d'
      bm' hm' v r tr tr' tr'' ams ams' ams'',
               exec_fbasic pr tr d bm hm fsxp ams p1 (Finished d' bm' hm' v) ams' tr' ->
