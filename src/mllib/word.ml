...
let wbit sz _ (W n) = W (wrap sz (Big_int.power_int_positive_big_int 2 n))
let wor _ (W a) (W b) = W (Big_int.or_big_int a b)
let wand _ (W a) (W b) = W (Big_int.and_big_int a b)
