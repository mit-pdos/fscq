...
unfold valuset2bytesets in H24; simpl.
unfold byteset2list in H24; simpl in H24.
rewrite v2b_rec_nil in H24.
replace (fun x : list byte => (valu2list (list2valu x), nil))
  with (fun x : list byte =>  x, nil:_) in H24.
